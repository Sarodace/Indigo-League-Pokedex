all: main.o pokemon_data.o gui.o load_files.o algorithms.o
	gcc-7 -iquote core/include `pkg-config --cflags gtk+-3.0` main.o pokemon_data.o gui.o load_files.o algorithms.o -o main `pkg-config --libs gtk+-3.0` -rdynamic
...
clean:
	rm -f main.o pokemon_data.o gui.o load_files.o algorithms.o main